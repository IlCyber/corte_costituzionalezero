...
function applicationCapabilityCatalog(): array
{
    ...
    $add('Partiti', 'parties', [
        ...
        ['party_statutes.link', 'Collegare statuti (Google o link esterni)', 'create'],
        ['party_statutes.change_link', 'Sostituire il collegamento degli statuti', 'edit', true],
    ...
    $add('Aziende', 'companies', [
        ...
        ['company_regulations.link', 'Collegare regolamenti dalla cartella Google Drive Regolamenti aziende', 'create'],
        ['company_regulations.change_link', 'Sostituire il collegamento dei regolamenti con un file della cartella Regolamenti aziende', 'edit', true],
    ...
    $add('Impostazioni generali', 'settings', [
        ...
        ['settings.google_folders.edit', 'Configurare le cartelle Google Drive (Documenti sito e Regolamenti aziende)', 'edit', true],
