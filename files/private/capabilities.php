...
function applicationCapabilityCatalog(): array
{
    ...
    $add('Partiti', 'parties', [
        ...
        ['party_statutes.link', 'Collegare statuti Google esistenti', 'create'],
    ...
    $add('Aziende', 'companies', [
        ...
        ['company_regulations.link', 'Collegare regolamenti Google esistenti', 'create'],
    ...
    $add('Impostazioni generali', 'settings', [
        ...
        ['settings.google_folders.edit', 'Configurare le cartelle Google Drive', 'edit', true],
