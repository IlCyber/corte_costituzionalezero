...
function applicationCapabilityCatalog(): array
{
    ...
    $add('Aziende', 'companies', [
        ...
        ['company_regulations.link', 'Collegare regolamenti (Google o link esterni)', 'create'],
        ['company_regulations.change_link', 'Sostituire il collegamento dei regolamenti', 'edit', true],
    ...
    $add('Impostazioni generali', 'settings', [
        ...
        ['settings.google_folders.edit', 'Configurare la cartella Google Drive', 'edit', true],
